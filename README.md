...
Apply a named or inline image transform to all (mathched) images. If installed, Retcon uses [Imager](https://github.com/aelvan/Imager-Craft) to apply the transform.
